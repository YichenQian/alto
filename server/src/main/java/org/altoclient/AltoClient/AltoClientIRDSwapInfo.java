...
public final class AltoClientIRDSwapInfo implements Cloneable {
    ...
    public AltoClientIRDSwapInfo() {
        ...
        resourceList = null;
        uri = AltoClientRightString.InvalidURI;
        operationStatus = AltoClientRightString.OperationFailure;
        ;
    }

    public AltoClientIRDSwapInfo(List<CostType> costTypeList, String defaultAltoNetworkMap, List<Resource> resourceList,
