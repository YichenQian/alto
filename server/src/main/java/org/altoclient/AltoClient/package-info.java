...
class AltoClientFilteredContentTypeString {
...
class AltoClientConstInternalMethod {
    public void methodName(String uri, List<String> hostNameRequestLine) {
