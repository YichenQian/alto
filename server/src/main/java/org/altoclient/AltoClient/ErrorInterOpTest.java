...
public final class ErrorInterOpTest {
    ...
    public ErrorInterOpTest(String operationError, String hostName, String requestLine, List<String> properties,
        ...
        try {
            ...
            /*
             * if(length ==-1) throw(new Exception("http error!"));
             */
    ...
    public ErrorInterOpTest(String operationError, String hostName, String requestLine, CostType costType,
            List<String> srcPids, List<String> dstPids, List<String> constraints) {
        if (hostName == null)
