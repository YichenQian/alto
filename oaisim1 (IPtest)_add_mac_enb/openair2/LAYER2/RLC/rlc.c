...
/*  
    //make change
    rlc[module_idP].m_rlc_pointer[rb_idP].rlc_type = RLC_AM;
    ...
    config_req_rlc_am(&rlc[module_idP].m_rlc_am_array[rlc[module_idP].m_rlc_pointer[rb_idP].rlc_index],
                           frame,eNB_flagP,module_idP,&Rlc_info_am_config.rlc.rlc_am_info,rb_idP, 2);
    
//    config_req_rlc_um(&rlc[module_idP].m_rlc_um_array[rlc[module_idP].m_rlc_pointer[rb_idP].rlc_index],
//			   frame,eNB_flagP,module_idP,&rlc_infoP.rlc.rlc_um_info,rb_idP, 2);
    ///////////////////////////

 */
    
//    printf("#######################rlc_data_req1");
              ...
              if (sdu_sizeP > 0) {
                  ...
                  switch (rlc[module_idP].m_rlc_pointer[rb_idP].rlc_type) {
                    ...
                    case RLC_AM:
                        ...
                        //make change
//                        FILE *fp=fopen("/home/cic/rlc_input.txt","w");
//                        fwrite(sduP->data,sdu_sizeP,1,fp);
//                        fclose(fp);
                        ////////////////////
                        ...
                        if (new_sdu != NULL) {
                          ...
                          //make change
                         /*
                          FILE* fp=fopen("/home/cic/ue_rlc_input.txt","w");
                          fwrite((rlc[module_idP].m_rlc_am_array[rlc[module_idP].m_rlc_pointer[rb_idP].rlc_index]
                                  .input_sdus[rlc[module_idP].m_rlc_am_array[rlc[module_idP].m_rlc_pointer[rb_idP].rlc_index]
                                  .next_sdu_index-1].mem_block->data),sdu_sizeP + sizeof (struct rlc_am_data_req_alloc),1,fp);
                          fclose(fp);
                          */
                          
                          int pdcp_sdu_size = sdu_sizeP + sizeof (struct rlc_am_data_req_alloc);
