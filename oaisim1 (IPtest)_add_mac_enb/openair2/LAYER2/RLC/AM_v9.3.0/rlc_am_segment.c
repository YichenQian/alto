...
//-----------------------------------------------------------------------------
    ...
    //make change
//    int *definehead;
//    definehead = malloc(10);
//    sprintf(definehead, "%04d \n", (int)frame);
//    FILE *fp=fopen("/home/administrator/rlc_am_segment_10","a+");
//    fwrite(definehead,6,1,fp);
//    fclose(fp);
    ///////////////////
    ...
    while ((rlcP->input_sdus[rlcP->current_sdu_index].mem_block) && (nb_bytes_to_transmit > 0) ) {
        ...
        if (!pdu_mem) {
            ...
            int a = sizeof(struct mac_tb_req);
        ...
        while ((rlcP->input_sdus[rlcP->current_sdu_index].mem_block) && (continue_fill_pdu_with_sdu > 0)) {
            ...
            //make change
//            FILE *fp=fopen("/home/administrator/data_sdu.txt","w");
//            fwrite(data_sdu,120,1,fp);
//            fclose(fp);
            ////////////////////
            ...
            if (sdu_mngt->sdu_remaining_size > pdu_remaining_size) {
                ...
                //make change
//                fp=fopen("/home/administrator/data_trans","a+");
//                fprintf(fp, "frame=%d  sdu>pdu \n", frame);
//                fclose(fp);
                ///////////////////
...
//                fclose(fp);
        ...
        //make change fack
        if (((rlcP->vt_s - rlcP->vt_a) & RLC_AM_SN_MASK) > 1)
        {
